package com.celsodiehl.todosimples.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                ...
                "Validação com erros. Verifique 'errors' field para mais detalhes.");
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(
        ...
        log.error("Falha ao Salvar Entidade.: with integrity problems: " + errorMessage,
    ...
    public ResponseEntity<Object> handleAuthenticationException(
            ...
            WebRequest request) {
        log.error("Autenticação error ", authenticationException);
        return buildErrorResponse(
    ...
    public ResponseEntity<Object> handleAccessDeniedException(
            ...
            WebRequest request) {
        log.error("Autorização error ", accessDeniedException);
        return buildErrorResponse(
